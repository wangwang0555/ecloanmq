...
class orderDao {
	...
	public function orderMothAdd($data) {
		...
		if (! empty ( $data )) {
			...
			} else if ($state_time >= strtotime ( "2015-11-01 00:00:00" ) && $state_time <= strtotime ( "2015-11-10 23:59:59" )) {
				$tableName = "ec_ecorder_orders2015110";
				$tableName2 = "ec_ecorder_childorders2015110";
			}else if ($state_time >= strtotime ( "2015-11-11 00:00:00" ) && $state_time <= strtotime ( "2015-11-11 23:59:59" )) {
				$tableName = "ec_ecorder_orders20151101";
				$tableName2 = "ec_ecorder_childorders20151101";
			}else if ($state_time >= strtotime ( "2015-11-12 00:00:00" ) && $state_time <= strtotime ( "2015-11-15 23:59:59" )) {
				$tableName = "ec_ecorder_orders20151102";
				$tableName2 = "ec_ecorder_childorders20151102";
			} else if ($state_time >= strtotime ( "2015-11-16 00:00:00" ) && $state_time <= strtotime ( "2015-11-27 23:59:59" )) {
				$tableName = "ec_ecorder_orders2015111";
				$tableName2 = "ec_ecorder_childorders2015111";
			} else if ($state_time >= strtotime ( "2015-11-28 00:00:00" ) && $state_time <= strtotime ( "2015-11-30 23:59:59" )) {
				$tableName = "ec_ecorder_orders20151111";
				$tableName2 = "ec_ecorder_childorders20151111";
			}else if ($state_time >= strtotime ( "2015-12-01 00:00:00" ) && $state_time <= strtotime ( "2015-12-05 23:59:59" )) {
				$tableName = "ec_ecorder_orders2015120";
				$tableName2 = "ec_ecorder_childorders2015120";
			}else if ($state_time >= strtotime ( "2015-12-06 00:00:00" ) && $state_time <= strtotime ( "2015-12-10 23:59:59" )) {
				$tableName = "ec_ecorder_orders20151201";
				$tableName2 = "ec_ecorder_childorders20151201";
			} else if ($state_time >= strtotime ( "2015-12-11 00:00:00" ) && $state_time <= strtotime ( "2015-12-15 23:59:59" )) {
				$tableName = "ec_ecorder_orders20151202";
				$tableName2 = "ec_ecorder_childorders20151202";
			}else if ($state_time >= strtotime ( "2015-12-16 00:00:00" ) && $state_time <= strtotime ( "2015-12-20 23:59:59" )) {
				$tableName = "ec_ecorder_orders2015121";
				$tableName2 = "ec_ecorder_childorders2015121";
			}else if ($state_time >= strtotime ( "2015-12-21 00:00:00" ) && $state_time <= strtotime ( "2015-12-25 23:59:59" )) {
				$tableName = "ec_ecorder_orders20151211";
				$tableName2 = "ec_ecorder_childorders20151211";
			}else if ($state_time >= strtotime ( "2015-12-26 00:00:00" ) && $state_time <= strtotime ( "2015-12-31 23:59:59" )) {
				$tableName = "ec_ecorder_orders20151212";
				$tableName2 = "ec_ecorder_childorders20151212";
			}
